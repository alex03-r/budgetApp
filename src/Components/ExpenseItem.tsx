...
export function ExpenseItem(props: ExpenseProp){
    ...
    return (
        ...
        <td className=" border border-slate-300 w-1/6 text-center italic ">{capitalizeName(props.name)}</td>
        <td className="border border-slate-300 w-1/6 text-center font-bold " style={{ backgroundColor:`${budgetColor}`, color:"black", borderRadius:'5px' }} >{capitalizeName(props.budget)}</td>
